...
class WeatherAdapter(
    private val days: List<ForecastModel>,
    private val onPressedListener: (ForecastModel) -> Unit = {}
    ...
    override fun onBindViewHolder(holder: WeatherViewHolder, position: Int) {
        holder.bind(days.elementAt(position), onPressedListener)
    }
    ...
    class WeatherViewHolder(
        ...
        fun bind(item: ForecastModel, onPressedListener: (ForecastModel) -> Unit) {
            binding.apply {
